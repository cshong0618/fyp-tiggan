...
class G_label_no_conv_4(nn.Module):
    def __init__(self, input_size=10, name="G_label_no_conv_4"):
        super(G_label_no_conv_4, self).__init__()
...
class G_rnn(nn.Module):
    def __init__(self, input_size=10, img_size=29):
        ...
        self.conv1 = nn.Sequential(
            ...
            nn.LeakyReLU(),
            nn.ConvTranspose2d(16, 8, kernel_size=5, stride=1, padding=1),
            nn.LeakyReLU(),
